...
contains('aduBuild259');
contains('ADU build price - complete construction estimate at $259 per square foot');
contains('onclick="addEstimateSqftBuildLine()"');
contains('function addEstimateSqftBuildLine()');
contains('$259/sf sample build pricing');
contains('Total / sq ft');
contains('Build price basis');
